...
namespace template_csharp_reviews_site.Migrations
{
    ...
    [Migration("20220624155529_addview")]
            ...
            modelBuilder.Entity("template_csharp_reviews_site.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Opinions = "Very Sharp!",
                            Positive = true,
                            Postdate = new DateTime(2022, 6, 24, 11, 55, 29, 419, DateTimeKind.Local).AddTicks(5138),
                            Rating = 4,
                            SchoolSupplyId = 1
                        },
                        new
                        {
                            ...
                            Opinions = "Very Cheap!",
                            Positive = false,
                            Postdate = new DateTime(2022, 6, 24, 11, 55, 29, 419, DateTimeKind.Local).AddTicks(5175),
                            Rating = 1,
                            SchoolSupplyId = 2
                        },
                        new
                        {
                            ...
                            Opinions = "Strudy",
                            Positive = true,
                            Postdate = new DateTime(2022, 6, 24, 11, 55, 29, 419, DateTimeKind.Local).AddTicks(5177),
                            Rating = 5,
                            SchoolSupplyId = 3
                        },
                        new
                        {
                            ...
                            Positive = true,
                            Postdate = new DateTime(2022, 6, 24, 11, 55, 29, 419, DateTimeKind.Local).AddTicks(5180),
                            Rating = 5,
                            SchoolSupplyId = 4
                        },
                        new
                        {
                            ...
                            Opinions = "Fantastic!!",
                            Positive = true,
                            Postdate = new DateTime(2022, 6, 24, 11, 55, 29, 419, DateTimeKind.Local).AddTicks(5182),
                            Rating = 5,
                            SchoolSupplyId = 5
                        });
                });
